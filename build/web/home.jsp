...
<html lang="en">
    <head>
        ...
        <title>ExploreVietnamTours</title>
        <!-- Favicon-->
    ...
    <body>
        ...
        <!-- Header-->
        <header class="bg-dark py-5" style="background-image: url('https://cdn.pixabay.com/photo/2020/09/13/16/16/terraces-5568679_1280.jpg'); background-size: cover;">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-w
                     hite">
                    <h1 class="display-4 fw-bolder" style="color: white">ExploreVietnamTours</h1>
